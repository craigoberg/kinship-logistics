...
function toBooking(r: EventBookingWithEvent, netLedgerSum = 0): EventRosterBooking {
  ...
  return {
    ...
    outboundTransportMode: "bus",
    returnTransportMode: "bus",
    outboundBusRunCode: null,
    returnBusRunCode: null,
    transportMedBagRequired: "not_set",
    transportMedNotes: null,
    pickupOrder: 0,
    fundingClaimType: "NDIS Plan Managed",
    chargeCodeId: null,
    quantityDelivered: 1,
    ratePerUnitApplied: null,
